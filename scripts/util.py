import select, time, electrum_desire, Queue
from electrum_desire import Connection, Interface, SimpleConfig
from electrum_desire.network import filter_protocol, parse_servers
from collections import defaultdict

# electrum_desire.util.set_verbosity(1)
