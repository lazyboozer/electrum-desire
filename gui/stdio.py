...
from electrum_desire.util import format_satoshis, set_verbosity
from electrum_desire.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_desire.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-desire create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Desire address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-desire setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-desire setconfig' to change your settings")
        return True
