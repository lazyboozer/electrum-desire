...
#send_button:disabled{
    color: #D3E8FE;
    border: 1px solid rgb(169, 109, 247);
    border-radius: 4px;
    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
...
QPushButton { /* Global Button Style */
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: .01 #8463d1, stop: .1 #8733cc, stop: .95 #8733cc, stop: 1 #6e1cb5);
    border:0;
    border-radius:3px;
    border-color: #622099;
    color:#ffffff;
...
QPushButton:hover {
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: .01 #8463d1, stop: .1 #9246de, stop: .95 #9246de, stop: 1 #7d1cb5);
}
...
QPushButton:disabled
{
    color: #ead3fe;
    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
stop: 0 #cea4f9, stop: 1 #b572f8);
}

QComboBox { /* Dropdown Menus */
    border:1px solid #a882e6;
...
QComboBox::down-arrow {
    border-image: url(':/icons/desire_downArrow.png') 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::up-button {
    ...
    background:#fcfcfc;
    border-left:0px;
    border-right:1px solid #ad82e6;
    border-top:1px solid #ad82e6;
    border-bottom:0px;
    padding-right:1px;
    padding-left:5px;
    padding-top:2px;
...
QAbstractSpinBox::down-button {
    ...
    border-left:0px;
    border-right:1px solid #ad82e6;
    border-bottom:1px solid #ad82e6;
    padding-right:1px;
    padding-left:5px;
    padding-bottom:2px;
}
...
QHeaderView::section { /* Table Header Sections */
    ...
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0.25, stop: 0 #b363d0, stop: 1 #b168d6);
    color:#fff;
    min-width: 50px;
    min-height:25px;
    font-weight:bold;
...
QScrollBar:up-arrow {
    background-image: url(':/icons/desire_upArrow_small.png');
}

QScrollBar:down-arrow {
    background-image: url(':/icons/desire_downArrow_small.png');
}

QScrollBar:left-arrow {
    background-image: url(':/icons/desire_leftArrow_small.png');
}

QScrollBar:right-arrow {
    background-image: url(':/icons/desire_rightArrow_small.png');
}
