...
from electrum_desire.masternode_budget import BudgetProposal, BudgetVote
from electrum_desire.masternode_manager import BUDGET_FEE_CONFIRMATIONS
from electrum_desire.util import block_explorer_URL, print_error, format_satoshis_plain
...
def budget_explorer_url(item_type, identifier):
    ...
    if item_type == 'proposal':
        return 'https://desirewhale.org/p/%s' % identifier
...
class ProposalsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        description = ''.join(['You can create a budget proposal below. ',
                'Proposals require 5 DSR to create. ',
        ...
        form.addRow(_('Payment Address:'), self.address_edit)
        form.addRow(_('Monthly DSR Payment:'), self.amount_edit)
