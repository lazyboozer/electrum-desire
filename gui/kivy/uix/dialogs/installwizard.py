...
from electrum_desire_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_desire.mnemonic import Mnemonic
        from electrum_desire.old_mnemonic import words as old_wordlist
