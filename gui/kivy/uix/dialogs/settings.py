...
from electrum_desire import coinchooser
from electrum_desire.util import fee_levels

from choice_dialog import ChoiceDialog

Builder.load_string('''
#:import partial functools.partial
#:import _ electrum_desire_gui.kivy.i18n._

<SettingsDialog@Popup>
    id: settings
    title: _('Electrum-DSR Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Desire amounts.")
                    action: partial(root.unit_dialog, self)
                CardSeparator
                SettingsItem:
                    status: root.fee_status()
                    title: _('Fees') + ': ' + self.status
                    description: _("Fees paid to the Desire miners.")
