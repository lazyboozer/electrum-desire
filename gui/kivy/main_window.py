...
import electrum_desire
from electrum_desire.bitcoin import TYPE_ADDRESS
from electrum_desire import WalletStorage, Wallet
from electrum_desire_gui.kivy.i18n import _
from electrum_desire.paymentrequest import InvoiceStore
from electrum_desire.util import profiler, InvalidPassword
from electrum_desire.plugins import run_hook
from electrum_desire.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_desire_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_desire_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_desire_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_desire_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_desire_gui.kivy.uix.screens')
...
from electrum_desire.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_desire.network import DEFAULT_PORTS
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'mDSR')
    ...
    def on_qr(self, data):
        from electrum_desire.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_desire.transaction import Transaction
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_desire.util import format_time
    ...
    def on_start(self):
        ...
        # bind intent for desire: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def load_wallet_by_name(self, path):
        ...
        if wallet:
            ...
            Logger.debug('Electrum-DSR: Wallet not found. Launching install wizard')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_desire_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_desire_gui.kivy.uix.qrcodewidget')
        ...
        self.icon = "icons/electrum-desire.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-DSR', message,
                            app_icon=icon, app_name='Electrum-DSR')
        except ImportError:
