...
pyinstaller \
    -y \
    --name electrum-desire-$ELECTRUM_DSR_VERSION.bin \
    osx.spec

sudo hdiutil create -fs HFS+ -volname "Electrum-DSR" \
    -srcfolder dist/Electrum-DSR.app \
    dist/electrum-desire-$ELECTRUM_DSR_VERSION-macosx.dmg
